...
apiku = 'https://github.com/Alifbotz'
gc_wa_lu = 'https://chat.whatsapp.com/IAtHcCvMYXqDvB47X0R61A' //klo gk punya gc wa gk usah di ganti 👍
...
case 'bcgif':
         ...
         ini_ownerNumber = [`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`]
					...
					var ini_gopayy =`Halo @${sender.split("@")[0]} noh yang punya bot, donasi ya banh🗿, masa numpang doang donasi lah biar bot ini semakin di depan agar Yamaha kalah(gw nangis om klo gk ada yg donasi 😩🥺,)`
var buttonss = [
			...
			case 'sticker': case 'stikerin':
				case 'stiker': case 's':{
						...
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							exif.create('Alif-BotZ', 'Wm by :The Mars Knowled Ft Pmeme', `stickwm_${sender}`)
							//ran = getRandom('.webp')
                        await ffmpeg(`./${media}`)
                            .input(media)
